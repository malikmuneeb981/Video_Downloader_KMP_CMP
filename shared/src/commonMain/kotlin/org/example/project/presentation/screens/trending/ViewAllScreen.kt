...
@Composable
fun ViewAllScreen(navController: NavController,downloaderViewModel: DownloaderViewModel) {
    ...
    Scaffold(topBar = {
        Column(modifier = Modifier.fillMaxWidth()) {
            TopBar(text = downloaderViewModel.trendingItemSelected.name.toString(), showBack = true, onBackClick = {
               navController.navigate(NavRoutes.TrendingHomeScreen.route)
            }, onPremiumClick = {
        ...
        Column(modifier = Modifier
            ...
            LazyVerticalGrid(
                ...
                items(items = downloaderViewModel.trendingItemSelected.videos?:emptyList(), key = {
                    it.id.toString()
                }){
                    TrendingVideoItem(
                        video = it,
