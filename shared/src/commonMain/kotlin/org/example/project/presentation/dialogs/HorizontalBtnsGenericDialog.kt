...
@Composable
fun HorizontalBtnsGenericDialog(dialogData: GenericDialogData,onDismiss:()-> Unit,
    ...
    Dialog(onDismissRequest = {
        ...
        Column(modifier = Modifier.fillMaxWidth().background(color = Color.White,
            ...
            Row(modifier = Modifier.fillMaxWidth().padding(
                ...
                BorderBtn(text = dialogData.negativeBtnText, modifier = Modifier.weight(1f).clickable(
                    indication = null,
                ...
                AppMainButton(text = dialogData.positiveBtnText, modifier = Modifier.weight(1f).clickable(
                    indication = null,
                    interactionSource = remember { MutableInteractionSource() },
                    onClick = {
                      onPositiveBtnClick()
...
private fun HorizontalBtnsGenericDialogPrev() {
    HorizontalBtnsGenericDialog(dialogData = GenericDialogData(image = Res.drawable.ic_delete_icon_dialog,
